...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('persobrasociales', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('persona_id')->nullable(false);
            $table->foreign('persona_id')->references('id')->on('personas')->onDelete('cascade');
            $table->unsignedBigInteger('obrasociale_id')->nullable(false);
            $table->foreign('obrasociale_id')->references('id')->on('obrasociales')->onDelete('cascade');           
    ...
    {
        Schema::dropIfExists('persobrasociales');
    }
};
