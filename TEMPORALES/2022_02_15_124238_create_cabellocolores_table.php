...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cabellocolores', function (Blueprint $table) {
            $table->id();
            $table->string('color', 50)->nullable(false)->charset('utf8mb4')->collation('utf8mb4_general_ci');
    ...
    {
        Schema::dropIfExists('cabellocolores');
    }
};
