...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('persotrosdatos', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('persona_id')->nullable(false);
            $table->foreign('persona_id')->references('id')->on('personas')->onDelete('cascade');
            $table->datetime('fecha')->nullable();
            $table->string('dato1', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('dato2', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('dato3', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
    ...
    {
        Schema::dropIfExists('persotrosdatos');
    }
};
