...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('armas', function (Blueprint $table) {
            ...
            $table->string('calibre', 10)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('equipo', 50)->nullable(false)->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('ipEquipo', 50)->nullable(false)->charset('utf8mb4')->collation('utf8mb4_general_ci');
