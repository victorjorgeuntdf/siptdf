...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('persdocumentos', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('pathDoc', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
    ...
    {
        Schema::dropIfExists('persdocumentos');
    }
};
