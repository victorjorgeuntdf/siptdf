...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('persprofesiones', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('persona_id')->nullable(false);
            $table->foreign('persona_id')->references('id')->on('personas')->onDelete('cascade');
            $table->unsignedBigInteger('profesione_id')->nullable(false);
            $table->foreign('profesione_id')->references('id')->on('profesiones')->onDelete('cascade');           
    ...
    {
        Schema::dropIfExists('persprofesiones');
    }
};
