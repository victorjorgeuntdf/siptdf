...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('vehiculos', function (Blueprint $table) {
            $table->id();
            $table->string('modelo', 100)->nullable(false)->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('marca', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
