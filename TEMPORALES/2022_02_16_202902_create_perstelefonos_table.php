...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('perstelefonos', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('persona_id')->nullable(false);
            $table->foreign('persona_id')->references('id')->on('personas')->onDelete('cascade');
            $table->unsignedBigInteger('persdomicilio_id')->nullable(false);
            $table->foreign('persdomicilio_id')->references('id')->on('persdomicilios')->onDelete('cascade');
            $table->string('nroTelefono', 50)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('descripcion', 100)->nullable(false)->charset('utf8mb4')->collation('utf8mb4_general_ci');
    ...
    {
        Schema::dropIfExists('perstelefonos');
    }
};
