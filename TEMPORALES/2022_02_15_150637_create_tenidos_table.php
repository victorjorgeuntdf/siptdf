...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tenidos', function (Blueprint $table) {
            $table->id();
            $table->string('descripcion', 20)->nullable(false)->charset('utf8mb4')->collation('utf8mb4_general_ci');
