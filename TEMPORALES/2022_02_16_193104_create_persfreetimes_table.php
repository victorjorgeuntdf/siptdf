...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('persfreetimes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('persona_id')->nullable(false);
            $table->foreign('persona_id')->references('id')->on('personas')->onDelete('cascade');
            $table->unsignedBigInteger('freetime_id')->nullable(false);
            $table->foreign('freetime_id')->references('id')->on('freetimes')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('persfreetimes');
    }
};
