...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('jerarquiasxescalafons', function (Blueprint $table) {
            $table->id();            
            ...
            $table->string('nombre', 100)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
            $table->string('abreviatura', 20)->nullable()->charset('utf8mb4')->collation('utf8mb4_general_ci');
    ...
    {
        Schema::dropIfExists('jerarquiasxescalafons');
    }
};
